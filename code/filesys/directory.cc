...
implementDirectoryHierarchy(sector, parentSector);
  #endif
}
...
void Directory::implementDirectoryHierarchy(int sector,int parentSector){
      //ajout des pointeurs vers les dossiers
      table[0].inUse=true;
